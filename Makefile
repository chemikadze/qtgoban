...
# Generated by qmake (2.01a) (Qt 4.6.2) on: ?? ???. 26 23:27:39 2010
# Project:  qtgoban.pro
# Template: app
...
compiler_moc_header_make_all: moc_sgfgame.cpp moc_gametree.cpp moc_abstractboard.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_sgfgame.cpp moc_gametree.cpp moc_abstractboard.cpp
