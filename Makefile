...
# Generated by qmake (2.01a) (Qt 4.6.2) on: ?? ???. 15 23:02:04 2010
# Project:  qtgoban.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt/mkspecs/linux-g++-64 -unix CONFIG+=debug -o Makefile qtgoban.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib -lQtGui -L/usr/lib -L/usr/X11R6/lib64 -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: qtgoban.pro  /usr/share/qt/mkspecs/linux-g++-64/qmake.conf /usr/share/qt/mkspecs/common/g++.conf \
		/usr/share/qt/mkspecs/common/unix.conf \
		/usr/share/qt/mkspecs/common/linux.conf \
		/usr/share/qt/mkspecs/qconfig.pri \
		/usr/share/qt/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -spec /usr/share/qt/mkspecs/linux-g++-64 -unix CONFIG+=debug -o Makefile qtgoban.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qtgoban1.0.0/ && $(COPY_FILE) --parents sgftree.h sgfgame.h sgfvariant.h common.h gametree.h .tmp/qtgoban1.0.0/ && $(COPY_FILE) --parents sgftree.cpp sgfgame.cpp sgfvariant.cpp main.cpp gametree.cpp .tmp/qtgoban1.0.0/ && (cd `dirname .tmp/qtgoban1.0.0` && $(TAR) qtgoban1.0.0.tar qtgoban1.0.0 && $(COMPRESS) qtgoban1.0.0.tar) && $(MOVE) `dirname .tmp/qtgoban1.0.0`/qtgoban1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qtgoban1.0.0
...
compiler_moc_header_make_all: moc_sgfgame.cpp moc_gametree.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_sgfgame.cpp moc_gametree.cpp
moc_sgfgame.cpp: common.h \
		sgftree.h \
		sgfvariant.h \
		sgfgame.h
	/usr/bin/moc $(DEFINES) $(INCPATH) sgfgame.h -o moc_sgfgame.cpp
...
moc_gametree.cpp: sgfgame.h \
		...
		sgfvariant.h \
		gametree.h
	/usr/bin/moc $(DEFINES) $(INCPATH) gametree.h -o moc_gametree.cpp
